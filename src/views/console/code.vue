    ...
    <el-row :gutter="20">
      <el-col :span="12">
        <el-form @submit.native.prevent :inline="true">
          <el-form-item>
            <el-button type="primary" :disabled="!actions.includes('ADD_CODE')" size="small" @click="openCodeAdd">新增</el-button>
          </el-form-item>
        </el-form>
        <el-table :data="codes" @row-click="showItem" highlight-current-row stripe border style="width: 100%;">
          <el-table-column label="操作" width="78">
            <template slot-scope="scope">
              <el-button-group>
                <el-button type="danger" size="small" :disabled="!actions.includes('REMOVE_CODE')" @click="removeCode(scope.row.code)">删除</el-button>
              </el-button-group>
            </template>
          </el-table-column>
      ...
      <el-col :span="12">
        <el-form @submit.native.prevent :inline="true">
          <el-form-item>
            <el-button type="primary" :disabled="code.code === undefined || !actions.includes('ADD_CODE_ITEM')" @click="openItemAdd" size="small">新增</el-button>
          </el-form-item>
        </el-form>
        <el-table :data="code.items" highlight-current-row border style="width: 100%;">
          <el-table-column align="center" label="操作" width="150">
            <template slot-scope="scope">
              <el-button-group>
                <el-button type="primary" @click="openItemEdit(scope.$index, scope.row)" :disabled="!actions.includes('EDIT_CODE_ITEM')" size="small">编辑</el-button>
                <el-button type="danger" @click="removeItem(scope.$index, scope.row)" :disabled="!actions.includes('REMOVE_CODE_ITEM')" size="small">删除</el-button>
              </el-button-group>
            </template>
          </el-table-column>
